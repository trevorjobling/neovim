...
-- Automatically load init.lua after saving it.
-- Create the autocommand to source init.lua when it's saved
vim.api.nvim_create_autocmd('BufWritePost', {
  ...
  callback = function()
    ...
    -- Optional: Add a notification that config was reloaded
...
--      },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'caddy' },
